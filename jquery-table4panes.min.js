...
/***jquery-table4panes1.1.0-jQueryplugintosplitthetabletofourpanes.**Copyright(c)2019ASAIEtsuhisa*ThissoftwareisreleasedundertheMITLicense.*http:**[Usage]*$.fn.table4panes(col_num,row_num,settings)*Splitthetabletofourpanes.**@paramthis(in)tablenodetosplittothepanes*@paramcol_num(in)numberofcolumnstofix*@paramrow_num(in)numberofrowstofix*@paramsettings(in)settingsfortable4panes*"display-method":("inline-block"|"table-cell"|"flex"|"float")-Selectthemethod.*"fit":(true|flase)-Iftrue,fitthebottomrightpanefitstheparentnode.*("height"|"top-height"|"bottom-height"|"width"|"left-width"|"right-width"):size-Setthesize.*"fix-width-rows":num-Fixthewidthofcolumnswiththespecifiednumberofrows.*"callbacks":{"selector1":{"event":"event1","func":"func1","data":"data1"},*"selector2":{"event":"event2","func":"func2","data":"data2"},...}-Setthecallbacks.*"css":{"selector1":"css-map1","selector2":"css-map2",...}-Mapthecss.*"prefix":"prefix"-Settheprefixfortheclassname.*@return thetopleveldivnode.**From:*+-tableid--------------------------+*|(col_num+***)x(row_num+***)|*||*|#withorwithoutthead/tbody/th/td |
 * +-------------------------------------+
 *
 * To:
 * +- div table4panes -------------------------------------------+
